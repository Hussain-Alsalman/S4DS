...
## We have already explored visualizing histograms to look at the shape of our data. 
...
ggplot(mpg, mapping = aes(y = hwy, x = manufacturer)) +
  ...
  coord_flip() + scale_y_continuous(breaks = 1:50) 
#+ geom_jitter(aes(color = model, group = manufacturer), show.legend = FALSE)
