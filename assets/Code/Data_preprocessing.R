###-----Helping Functions ---------####
library('here')
source(file = here("assets","Code", "help_Functions.R"))
...
# some values might need to consult with the domain expert, In this example the zip code might relate ~
# to a country where they use mixed letters and numeric such as Canada. 

# We have value of only four digit for customer ID 1004
...
# while "M" could mean married and "D" mean Divorce and "W" Widowed, "S" could mean Single or Separated. 
...
file_path <- here("assets", "Data", "example_cars.txt") 
...
# We now Impute missing values with the mean 
