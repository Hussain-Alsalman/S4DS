...
get_mode <- function(v) { 
  ...
  uniq[which.max(
    ...
    ] # we assign indexes in match, then show their # of occurrences, take max, use it as index in unique values 
}
...
## We can visualize the data to determine the mode and median
library('ggplot2') 
