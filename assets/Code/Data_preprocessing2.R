...
file_path <- here("assets", "Data", "outlier_cars.txt")
...
# one of the best practices is to normalize the data. This is basically making all continuous variables within the same unit
...
# You can see that this is very sensitive to outliers 
...
# the formula for the z-score is fairly simple 
